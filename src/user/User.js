      ...
      <div className="user__bottom">
       <div className="user-container">
        ...
        <div className="user-container__item user__change-password">
         <div className="user-container__item--title">Current Password</div>
         <TextField size="small" variant="outlined" style={{width: "80%"}} />
         <div className="user-container__item--title">New Password</div>
         <TextField size="small" variant="outlined" style={{width: "80%"}} />
         <div className="user-container__item--title">Confirm New Password</div>
         <TextField size="small" variant="outlined" style={{width: "80%"}} />
        </div>
       </div>
       <div className="user-container">
